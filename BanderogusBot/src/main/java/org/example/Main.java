...
public class Main extends TelegramLongPollingBot {
    //BanderogusByViktorBaran
    //6147705319:AAEJ4hTStDdrC-ZfFNdWBtbZ2S4yZb519mc
    ...
    public String getBotUsername() {
        return "BanderogusByViktorBaran";
    }

    @Override
    public String getBotToken() {
        return "6147705319:AAEJ4hTStDdrC-ZfFNdWBtbZ2S4yZb519mc";
    }
    ...
    public void onUpdateReceived(Update update) {
        ...
        if(update.hasCallbackQuery()){
            if(update.getCallbackQuery().getData().equals("level_1_task") && getLevel(chatId) == 1){
                ...
                buttons = getRandomNumb(buttons, 3);
            ...
            if(update.getCallbackQuery().getData().equals("level_2_task") && getLevel(chatId) == 2){
                ...
                buttons = getRandomNumb(buttons, 2);
    ...
    public List<String> getRandomNumb(List<String> variants, int numb){
        ArrayList<String> copy = new ArrayList<>(variants);
        Collections.shuffle(copy);
        return copy.subList(0, numb);
    }
}